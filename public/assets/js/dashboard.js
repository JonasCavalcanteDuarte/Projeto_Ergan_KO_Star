...
function updateChart(startDate, endDate) {
    // Lê os dados passados do PHP através do id "salesData"
    const orderData = JSON.parse(document.getElementById('orderData').textContent);

    const datas = orderData.datas;
    const qtdPedidos = orderData.qtdPedidos;
...
function updateChart2(startDate, endDate) {
    ...
    const order_status = orderStatusData.order_status;
    const qtdPedidos = orderStatusData.qtdPedidos;
